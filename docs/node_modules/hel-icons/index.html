...
<html lang="en">
    <head>
        ...
        <title> Helsinki SVG icons |  </title>
...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <main>
          <h1 id="helsinki-svg-icons">Helsinki SVG icons</h1>

<p>City of Helsinki brand identity icon set.</p>

<h2 id="installation">Installation</h2>

<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install hel-svg-icons
</code></pre></div></div>
<p>you only need hel-icons.svg file.</p>

<h2 id="how-to-use">How to use</h2>

<p>Insert icon in inline content.</p>
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>&lt;svg aria-hidden="true" class="icon"&gt;&lt;use xlink:href="path-to/dist/symbol/svg/hel-icons.svg#book"&gt;&lt;/use&gt;&lt;/svg&gt;
</code></pre></div></div>

<p>To make sure icons appear correct size depending on context include this default to styles</p>
...
<h3 id="decorative-icon">Decorative icon</h3>
<p>When icon is used for decoration or emphasis it should be hidden from screen readers with <code class="highlighter-rouge">aria-hidden=true</code></p>

<h3 id="interactive-icon-without-text">Interactive icon without text</h3>
<p>When the icon is used without explanatory text as purely visual cue in UI you should provide a screen reader -friendly aria-label. In interactive elements this should be included in the wrapping <code class="highlighter-rouge">&lt;a&gt;</code> or <code class="highlighter-rouge">&lt;button&gt;</code> element.</p>
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>&lt;a href="/news/" aria-label="Latest News"&gt;
  &lt;svg aria-hidden="true"&gt;
    &lt;use xlink:href="path-to/dist/symbol/svg/hel-icons.svg#book"&gt;&lt;/use&gt;
  &lt;/svg&gt;
&lt;/a&gt;
</code></pre></div></div>
<h3 id="informative-icon-without-text">Informative icon without text</h3>
<p>When icon is not wrapped in interactive element, svg title can be used.</p>
...
<p>This spritemap displays fine in Chrome, Safari 7.1+, Firefox, and Opera.</p>

<p>For extended browser support (Safari 6, IE 6+, and Edge 12) you should use <a href="https://github.com/jonathantneal/svg4everybody">svg4everybody</a>.</p>
...
<p>Add new svg files in <code class="highlighter-rouge">src/svg/</code>. For icon naming try to follow <a href="http://fontawesome.io">Font Awesome</a> naming practices.</p>

<p>Compile svg sprite file.</p>
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>grunt dev
</code></pre></div></div>
<p>View the test page on your browser in http://localhost:9090</p>

<h2 id="further-reading">Further reading</h2>
<ul>
  <li><a href="https://fvsch.com/code/svg-icons/how-to/">Florens Verschelde: How to work with SVG icons</a></li>
</ul>
