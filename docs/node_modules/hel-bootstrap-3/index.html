          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              <a class="btn btn-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <svg aria-hidden="true" class="icon"><use xlink:href="node_modules/hel-icons/dist/symbol/svg/hel-icons.svg#globe"></use></svg>
                English
              </a>
            ...
            <li class="nav-item dropdown">
              <a class="btn btn-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <svg aria-hidden="true" class="icon"><use xlink:href="node_modules/hel-icons/dist/symbol/svg/hel-icons.svg#user-o"></use></svg>
                Cajsa Catterson
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
    ...
    <div class="row">
      <div class="col-11 col-md-10 col-lg-8">
        <div class="hero-content hero-content--inverse">
          ...
          <button type="button" class="btn btn-outline-light">Calculate & Pay Now</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h1 class="display-1"><svg aria-hidden="true" class="icon"><use xlink:href="node_modules/hel-icons/dist/symbol/svg/hel-icons.svg#ticket"></use></svg></h1>
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h1 class="display-1"><svg aria-hidden="true" class="icon"><use xlink:href="node_modules/hel-icons/dist/symbol/svg/hel-icons.svg#trash-o"></use></svg></h1>
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h1 class="display-1"><svg aria-hidden="true" class="icon"><use xlink:href="node_modules/hel-icons/dist/symbol/svg/hel-icons.svg#pencil"></use></svg></h1>
