      ...
      <div>
        ...
        <nav class="navbar navbar-expand-sm navbar-light justify-content-between">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="btn btn-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <nav class="navbar navbar-expand-lg navbar-light service-navbar">
          <a class="navbar-brand" href="#">Cat Tax Service</a>
        ...
        <main>
            <section class="hero-section bg-light" style="background-image: url('https://source.unsplash.com/collection/139386/1600x900')">
  <div class="container">
    <div class="row">
      <div class="col-11 col-md-10 col-lg-8">
        <div class="hero-content hero-content--inverse">
          <h1>Cat Tax Collection in Helsinki</h1>
          <p class="lead">Take care of your cat tax payment online. (Actually we do not tax cats in Helsinki. This is for layout demonstration purposes only)</p>
          <button type="button" class="btn btn-outline-light"  data-toggle="modal" data-target="#feedbackModal">Calculate & Pay Now</button>
        </div>
      </div>
    </div>
  </div>
...
<section class="cards-section">
  <div class="container">
    <h2>Taxed Cat is a Happy Cat</h2>
    <div class="row">
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h1 class="display-1"><svg aria-hidden="true" class="icon"><use xlink:href="assets/hel-icons.svg#ticket"></use></svg></h1>
            <h5 class="card-title">Why Do I have to Pay?</h5>
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h1 class="display-1"><svg aria-hidden="true" class="icon"><use xlink:href="assets/hel-icons.svg#trash-o"></use></svg></h1>
            <h5 class="card-title">Cat Tax Exemptions</h5>
            <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
            <a href="#" class="btn btn-primary">Go somewhere</a>
          </div>
        </div>
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h1 class="display-1"><svg aria-hidden="true" class="icon"><use xlink:href="assets/hel-icons.svg#pencil"></use></svg></h1>
            <h5 class="card-title">Calculate and Pay Now</h5>
            <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
            <a href="#" class="btn btn-primary">Go somewhere</a>
          </div>
        </div>
...
<section class="map-section">
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        <h2>Where can I Pay My Cat Tax?</h2>
        <p class="lead">sdöfhn sdgjkdns fkgjlbdn fslgjkbdfs lkgjbdfns kgjnsdf klgjdsbfn gkjdsfbn lksdbnsdflg</p>
      </div>
      <div class="col-sm-6">
        <div style="position: relative; width:100%; padding-bottom:62%;">
        <iframe style="position: absolute; top: 0; left: 0; border: none; width: 100%; height: 100%;" src="https://servicemap.hel.fi/embed/unit?treenode=17&city=helsinki"></iframe></div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-10 col-md-8 col-lg-6 mx-auto">
        <h2>Cat Tax Calculator</h2>
        <p class="lead">Fill in the form to find out how much cat tax you owe.</p>
        <form>
          <div class="form-group">
            <label for="exampleFormControlInput1">Name of the cat</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Chairman Meaow">
          </div>
          <div class="form-group">
            <label for="exampleFormControlSelect1">Expecting kittens? How Many?</label>
          ...
          <div class="form-group">
            <label for="exampleFormControlSelect2">Does your cat go out?</label>
            <select multiple class="form-control" id="exampleFormControlSelect2">
              <option>Never</option>
              <option>Occasionally on a leash</option>
              <option>Daily on a leash</option>
              <option>Occasionally free</option>
              <option>Daily free</option>
            </select>
          </div>
          <div class="form-group">
            <label for="exampleFormControlTextarea1">Describe the cat's appearance</label>
...
<div class="modal fade" id="feedbackModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" style="position: absolute; top: 10px; right: 10px; font-size: 32px; line-height: 24px;" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
        <div class="feedback-frame">
			    <iframe src="feedback.html" style="width: 100%; height: 720px; border: 0; display: block;" ></iframe>
		    </div>
    </div>
  </div>
</div>

<div class="feedback-floating" style="transform-origin: top right; transform: rotate(90deg); position: fixed; bottom: 1em; right: -3px; z-index: 1041;">
    <a href="" class="feedback-trigger--float" data-toggle="modal" data-target="#feedbackModal">
  ...
  <a href="" data-toggle="modal" data-target="#feedbackModal" class="feedback-bubble">
    <span>Palaute</span>
  </a>
