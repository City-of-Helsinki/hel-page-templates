  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link user-menu__trigger" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <span class="user-name">Cajsa Catterson</span>
      </a>
      <div class="dropdown-menu dropdown-menu-right user-menu__dropdown" aria-labelledby="navbarDropdown">
        <span class="dropdown-header user-name">Cajsa Catterson</span>
        <a class="dropdown-item" href="oma-admin.html">Preferences</a>
        <a class="dropdown-item" href="oma-admin.html">Edit Profile</a>
        <a class="dropdown-item" href="oma.html">oma.helsinki</a>
...
<section class="section section--cards">
  <div class="container">
    <h2 class="section-header">Taxed Cat is a Happy Cat</h2>
    <div class="row">
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">With <a href="#">supporting</a> text below as a natural lead-in to additional content.</p>
...
<script id="feedback-script" data-app="" type="text/javascript" src="https://dev.hel.fi/~tituomin/feedback-widget/widget.js" ></script>
      </main>
